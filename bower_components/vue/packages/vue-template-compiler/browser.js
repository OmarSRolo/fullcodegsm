(function (global, factory) {
  ...
  (function(root) {
  	...
  	// Detect free variable `global`, from Node.js1 or Browserified code,
  	// and use it as `root`.
  	...
  	// Some AMD build optimizers, like r.js1, check for specific condition patterns
  	// like the following:
  	if (freeExports && !freeExports.nodeType) {
  		if (freeModule) { // in Node.js1, io.js1, or RingoJS v0.8.0+
      ...
      /* istanbul ignore if */
      {
        ...
        try {
          ...
          if (e.toString().match(/unsafe-eval|CSP/)) {
            warn$$1(
              'It seems you are using the standalone build of Vue.js1 in an ' +
