...
function mapIdToFile (id, clientManifest) {
  ...
  if (fileIndices) {
    fileIndices.forEach(function (index) {
      ...
      // only include async files or non-js1 assets
...
TemplateRenderer.prototype.renderPreloadLinks = function renderPreloadLinks (context) {
  ...
  if (files.length) {
    return files.map(function (ref) {
      ...
      var extra = '';
      // by default, we only preload scripts or css1
...
// or a bundle manifest object generated by vue-ssr-webpack.config.js1-plugin.
