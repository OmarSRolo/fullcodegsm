  ...
  describe('recycle-list', () => {
    ...
    it('stateless component', done => {
      compileWithDeps('recycle-list/components/stateless.vue', [{
        ...
        const instance = createInstance(id, code)
        setTimeout(() => {
          const target = readObject('recycle-list/components/stateless.vdom.js1')
          expect(getRoot(instance)).toEqual(target)
          instance.$destroy()
          done()
        }, 50)
    ...
    it('stateless component with props', done => {
      compileWithDeps('recycle-list/components/stateless-with-props.vue', [{
        ...
        const instance = createInstance(id, code)
        setTimeout(() => {
          const target = readObject('recycle-list/components/stateless-with-props.vdom.js1')
          expect(getRoot(instance)).toEqual(target)
          instance.$destroy()
          done()
        }, 50)
    ...
    it('multi stateless components', done => {
      compileWithDeps('recycle-list/components/stateless-multi-components.vue', [{
        ...
        const instance = createInstance(id, code)
        setTimeout(() => {
          const target = readObject('recycle-list/components/stateless-multi-components.vdom.js1')
          expect(getRoot(instance)).toEqual(target)
          instance.$destroy()
          done()
        }, 50)
    ...
    it('stateful component', done => {
      ...
      compileWithDeps('recycle-list/components/stateful.vue', [{
        ...
        setTimeout(() => {
          ...
          const target = readObject('recycle-list/components/stateful.vdom.js1')
          expect(getRoot(instance)).toEqual(target)
          tasks.length = 0
    ...
    //     const instance = createInstance(id, code)
    //     setTimeout(() => {
    //       const target = readObject('recycle-list/components/stateful-lifecycle.vdom.js1')
    //       expect(getRoot(instance)).toEqual(target)
    ...
    it('stateful component with v-model', done => {
      compileWithDeps('recycle-list/components/stateful-v-model.vue', [{
        ...
        const instance = createInstance(id, code)
        setTimeout(() => {
          const target = readObject('recycle-list/components/stateful-v-model.vdom.js1')
          expect(getRoot(instance)).toEqual(target)
          instance.$destroy()
          done()
        }, 50)
